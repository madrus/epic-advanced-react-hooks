...
> Amazing how KcD plays around with _functions_ instead of _arrow functions_ and uses just one import of `React` and then gets any of its properties anywhere in the code any time.

Here is an amazing example of this and also of how simple one can make the return JSX of the provider:
